...
def get_config():
        ...
        parser.add_argument('--dim', type=int, default=10,help='dimension of variables features')
        ...
        parser.add_argument('--env_size',type=list,default=[600,750,900],help='number of samples in each environment')
        parser.add_argument('--n_samples', type=list, default=[600,750,900],help='sets of number of samples in each environment (training)')
        ...
        # ----------------------------------------- TRACE-EA --------------------------------------------------------
        parser.add_argument('--test_zone',type=int, default=100, help='test zone size for TRACE-EA')
        ...
        # ---------------------------------- EA Optimization setting (fair for comparison) ---------------------------------------------
        ...
        parser.add_argument('--max_arc', type=int, default=30,help='max size of archive')
